# Credit: https://github.com/takluyver/bash_kernel/blob/master/bash_kernel/install.py
...
kernel_json = {"argv":[sys.executable,"-m","Azure CLI kernel", "-f", "{connection_file}"],
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description='Install KernelSpec for Azure CLI Kernel'
    )
